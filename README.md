...
<h1 align="center" style="text-align:center">ReactPWA - PawJS & Social Auth</h1>


Example repository for integrating Social Auth with ReactPWA project. This repo demonstrates the usage & integration of Social Auth in existing ReactPWA project using React-Cookie.
...
```bash
git clone https://github.com/Atyantik/example-pawjs-social-auth.git reactpwa-social-auth && cd reactpwa-social-auth
```
...
### License
This project is licensed under the MIT license, Copyright (c) 2018 [Atyantik Technologies Private Limited](https://www.atyantik.com). For more information see [LICENSE.md](https://github.com/Atyantik/example-pawjs-social-auth/blob/master/LICENSE.md).  
