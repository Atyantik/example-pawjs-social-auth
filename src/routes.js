  ...
  apply(routeHandler) {
    ...
    routeHandler.hooks.initRoutes.tapPromise('AppRoutes', async () => {
      ...
      routeHandler.setPwaSchema({
        name: 'ReactPWA | Social Auth',
        short_name: 'RPWAA',
        dir: 'ltr',
        lang: 'en-US',
        orientation: 'any',
        start_url: '/examples/social-auth',
        background_color: '#111',
        theme_color: '#111',
        display: 'standalone',
        description: 'Social Auth implementation using ReactPWA',
        icons: [
          {
            src: ShareImg72,
            sizes: '72x72',
      ...
      routeHandler.getDefaultSeoSchema = () => ({
        title: 'ReactPWA | Social Auth',
        name: 'ReactPWA | Social Auth',
        description: 'Social Auth implementation using ReactPWA',
        type: 'website',
        url: 'https://www.reactpwa.com/examples/social-auth',
        site_name: 'ReactPWA',
        ...
        meta: [
          ...
          {
            name: 'description',
            content: 'Social Auth implementation using ReactPWA',
          },
          {
            name: 'theme-color',
            content: '#111',
